...
```sh
stow -t ~ alacritty atac bash fish gitconfig lazygit nvim tmux
```
...
```sh
stow -t ~ alacritty atac bash fish gitconfig lazygit niri nvim systemd tmux
```

### 2. Setup Swaybg (Wallpaper) **[Linux Only]**
